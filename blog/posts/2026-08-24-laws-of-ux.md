Learning notes from [lawsofux.com](https://lawsofux.com/).
...
*Closely related to Hick's Law.*

**Takeaways**

1. Too many options hurt users' decision-making ability. How they feel about the experience as a whole can be significantly impacted as a result.
...
3. We can avoid choice overload by optimizing our designs for the decision-making process and avoid overwhelming users by prioritizing the content that's shown to them at any given moment (e.g. featured product), providing tools for narrowing down choices up front (search and filtering).
...
*Closely related to Miller's Law.*
...
*Still working through the rest of the site — more laws to come.*
